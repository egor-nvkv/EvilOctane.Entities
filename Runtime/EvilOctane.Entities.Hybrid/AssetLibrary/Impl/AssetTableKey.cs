...
namespace EvilOctane.Entities
{
    ...
    public unsafe struct AssetTableKey : IEquatable<AssetTableKey>
    {
        public ulong AssetTypeHash;
        public ByteSpan AssetName;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AssetTableKey(ulong assetTypeHash, ByteSpan assetName)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(AssetTableKey other)
        {
            return AssetTypeHash == other.AssetTypeHash && AssetName == other.AssetName;
        }
        ...
        public struct Hasher : IHasher64<AssetTableKey>
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly ulong CalculateHash(in AssetTableKey value)
            {
