...
{
    [BurstCompile]
    public unsafe struct OwnedEntityBufferCleanupJobParallel<TOwnedEntityBufferElement, TAliveTag> : IJobChunk
        ...
        where TAliveTag : unmanaged, ICleanupComponentsAliveTag
    {
        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            {
                // Destroy
                CommandBuffer.DestroyEntity(unfilteredChunkIndex, toDestroyList.Ptr, toDestroyList.Length);
            }

            Entity* entityPtr = chunk.GetEntityDataPtrRO(EntityTypeHandle);

            // Clean up
            CommandBuffer.RemoveComponent<TOwnedEntityBufferElement>(unfilteredChunkIndex, entityPtr, chunk.Count);
        }
    }
}
